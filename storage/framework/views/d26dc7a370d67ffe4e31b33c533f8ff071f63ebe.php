                        ...
                        <ul class="dropdown-menu" role="menu" style="background-color: rgba(255,255,255,1); color: #333;">
                            <li><a href="../../../../ereceptionhub/public/dashboard"> <i class="fa fa-tachometer"> </i> Admin Dashboard </a><li>
                                ...
                                <?php if(auth()->user()->user_level > '4'): ?>
                                    <li><a href="../../../../ereceptionhub/public/administration"> <i class="fa fa-user-plus"> </i> User Administration </a><li>                                        <li><a href="../../ereceptionhub/public/fire"> <i class="fa fa-fire-extinguisher"> </i> Fire Safety </a><li>
                                <?php endif; ?>
...
</nav><?php /**PATH C:\xampp2\htdocs\ereceptionhub\resources\views/inc/navbar4.blade.php ENDPATH**/ ?>