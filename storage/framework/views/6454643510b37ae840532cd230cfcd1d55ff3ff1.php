<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        ...
        <li class="nav-item" id="contact">
            <a class="nav-link" href="/ereceptionhub/public/contact"> <i class="fa fa-phone"></i> Contact Us</a>
                    ...
                    <ul class="nav navbar-nav navbar-right">    
                        ...
                        <?php if(Auth::guest()): ?>
                            <li><a href="<?php echo e(route('login')); ?>" style="font-size: 15px; color: #fff;"> <i class="fa fa-sign-in fa-lg"> </i> Login</a></li>&nbsp;&nbsp;&nbsp;
                            <li><a href="<?php echo e(route('register')); ?>" style="font-size: 15px; color: #fff;"> <i class="fa fa-user-plus"> </i> Registration</a></li>
                        <?php else: ?>
                            <li class="nav-item dropdown" style="padding-right: 60px;">
                                <a href="#" class="nav-link dropdown-toggle" id="dropdown01"  data-toggle="dropdown" role="button" aria-expanded="false" style="color: #fff;">
                                        <i class="fa fa-user fa-lg"> </i> <?php echo e(Auth::user()->first_name); ?> <?php echo e(Auth::user()->last_name); ?>
  ...
  </nav><?php /**PATH C:\xampp2\htdocs\ereceptionhub\resources\views/inc/webnav.blade.php ENDPATH**/ ?>