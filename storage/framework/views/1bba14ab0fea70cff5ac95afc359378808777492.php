    ...
    <div class="row justify-content-center">
        <div class="col-12">
            <div class="panel" style="background-color: rgba(0,0,0,0.5); color: #fff; padding: 20px; max-width: 90vw; margin: auto;">
                <div class="panel-header"><h2><?php echo e(__('messages.searchdep')); ?></h2></div>
                ...
                <div class="panel-body" style="margin-left: 30px;">
                    <?php if(count($dep) > 0): ?>
                        <?php $__currentLoopData = $dep; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <hr><p>Department: <?php echo e($d->department_name); ?> </p><hr>
                        ...
                        <?php $__currentLoopData = $people; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-6 col-xs-6 col-sm-4 col-md-3 col-lg-2" style="color: #333; margin-top: 10px;">
                                <div style="width: 98%; height: 275px; background-color: rgba(255, 255, 255, 0.5); padding: 10px; border-radius: 10px;">
                                    <center>
                                        <img src="../../ereceptionhub/storage/app/public/mug_shots/<?php echo e($p->avatar); ?>" style="width: 90%;  max-width: 120px; margin-bottom: 5px;  border-radius: 50%;  border: solid 1px #eee;">
                                        <hr style="border-color: #333; margin: 0 0 0 0;">
                                            <span style="font-size: 10px; font-weight: 800;"><?php echo e($p->first_name); ?> <?php echo e($p->last_name); ?></span>
                                        <hr style="border-color: #333; margin: 0 0 0 0;">
                                            <span style="font-size: 10px; font-weight: 800;"><?php echo e($p->job_title); ?></span> 
                                        <hr style="border-color: #333; margin: 0 0 10px 0;">
                                        <a href="signin/<?php echo e($p->id); ?>" class="btn btn-primary btn-sm" style="position: absolute; bottom: 5px; width: 60%; left: 50%; margin-left: -30%;"> <i class="fa fa-sign-in fa-lg"> </i> Sign In</a>
                                    </center>
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.hub', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\ereceptionhub\resources\views/pages/search_by_dep.blade.php ENDPATH**/ ?>