    ...
    <div class="row justify-content-center">
        <div class="col-12">
            <div class="panel" style="background-color: rgba(0,0,0,0.5); color: #fff; padding: 20px; max-width: 90vw; margin: auto;">
                <div class="panel-header"><h2><?php echo e(__('messages.dashboard')); ?></h2></div>
                ...
                <div class="panel-body">
                    ...
                    <?php endif; ?>
                        ...
                        ?>
                        <center>
                            <p>Hub Location: <?php echo e($loc_name); ?></p><br>
                        ...
                        <center>
                            <div class="col-md-4 col-md-offset-4">
                                ...
                                <form action="<?php echo e(route('ereception.location')); ?>" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="loc" class="form-control">
                                            ...
                                            <?php $__currentLoopData = $location; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($loc->id); ?>"><?php echo e($loc->location_name); ?> Hub <?php echo e($loc->location_code); ?></option>
                        ...
                        <?php echo $__env->make('inc.fire_checks', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <br><br>
...
<?php echo $__env->make('layouts.app2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\ereceptionhub\resources\views/pages/dashboard.blade.php ENDPATH**/ ?>