    ...
    <div class="row justify-content-center">
        <div class="col-12">
            <div class="panel" style="background-color: rgba(0,0,0,0.5); color: #fff; padding: 20px; max-width: 90vw; margin: auto;">
                ...
                <div class="panel-header"><h2><?php echo e(__('messages.yearly')); ?></h2></div>

                <div class="panel-body">

                    <form action="<?php echo e(route('pagescontroller.yearly_checklist')); ?>" method="post">
...
<?php echo $__env->make('layouts.fire', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\ereceptionhub\resources\views/pages/yearly_checklist.blade.php ENDPATH**/ ?>