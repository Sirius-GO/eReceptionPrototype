    ...
    <div class="row justify-content-center">
        <div class="col-12">
            <div class="panel" style="background-color: rgba(0,0,0,0.5); color: #fff; padding: 20px; max-width: 90vw; margin: auto;">
                <div class="panel-header"><h2>{{ __('messages.firedrill') }}</h2></div>
                        ...
                        @if($rec->reg_type === 'Staff')
                            ...
                            <div class="row" style="margin-top: 5px;">
                                <span class="col-xs-12 col-sm-6 col-md-6 col-lg-2 col-xl-2 fire_mod_staff">
                                    <span class="fire_type_text"><b><i class="fa fa-id-card"></i> {{ $rec->reg_type }}</b>
                                        <span class="pull-right">
                                            <a href="fire_details/{{$rec->rid}}" class="dots">
                                ...
                                @endif
                                    <span class="badge">Name: </span> <?php echo substr($rec->name, 0, 25); ?>
                                        <br>
                                    <span class="badge">Department:  </span> {{ $rec->department_name }}
                                </span>
                                @if($si_tm === $t)
                                ...
                                @endif
                                    ...
                                    <br>
                                    <span class="badge">Sign In Time: </span> {{ date('d/m/Y H:i:s', strtotime($rec->crestat)) }}
                                </span>
                                @if($si_tm === $t)
                        ...
                        <!-- =================================================   VISITOR  =========================== -->
                            ...
                            <div class="row" style="margin-top: 5px;">
                                <span class="col-xs-12 col-sm-6 col-md-6 col-lg-2 col-xl-2 fire_mod_vis">
                                    <span class="fire_type_text"><b><i class="fa fa-user-circle"></i> {{ $rec->reg_type }}</b>
                                        <span class="pull-right">
                                            <a href="fire_details/{{$rec->rid}}" class="dots">
                                                <i class="fa fa-ellipsis-v fa-lg"></i> 
                                            </a>&nbsp;&nbsp;&nbsp; 
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{ route('pagescontroller.fire_not_present') }}" method="POST">
                {{ csrf_field() }}
