    ...
    <div class="row justify-content-center">
        <div class="col-12">
            <div class="panel" style="background-color: rgba(0,0,0,0.5); color: #fff; padding: 20px;">
                <div class="panel-header"><h3>{{ __('Register Master User') }}</h3>
                    <h5 style="font-size: 15px; font-weight: 700; color: orange;">Important Note! Only register one master user per organisation. All other users are added later via the User Administration Panel.</h5>
                    <p style="font-size: 12px; font-weight: 900; color: orange;">All Master User details can be changed later in Account Settings</p>
                </div>
